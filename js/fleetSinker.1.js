...
var FleetSinkerTower = function(TDgame){
    ...
    this.weapon = TDgame.add.weapon(30, 'spaceItems', 'laserGreen13.png');
    ...
    var fireRadius = TDgame.add.graphics();
    TDgame.physics.arcade.enable(fireRadius);
